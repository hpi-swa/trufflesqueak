...
public class SqueakInImageTest extends AbstractSqueakTestCase {
    ...
    public void testXPassingSqueakTests() {
        String[] testClasses = {"AddPrefixNamePolicyTest",
                        "AliasTest",
                        "AllNamePolicyTest",
                        "AssociationTest",
                        "BagTest",
                        ...
                        "EventManagerTest",
                        "ExpandedSourceFileArrayTest",
                        "ExplicitNamePolicyTest",
                        "GenericUrlTest",
                        "GlobalTest",
                        "HandBugs",
                        "HashAndEqualsTestCase",
                        "HashedCollectionTest",
                        "HashTesterTest",
                        "HelpIconsTest",
                        ...
                        "MessageSendTest",
                        "MonthTest",
                        "MorphicExtrasSymbolExtensionsTest",
                        "NamePolicyTest",
                        "OrderedCollectionTest",
                        "OrderedDictionaryTest",
                        "PackagePaneBrowserTest",
                        "PluggableMenuItemSpecTests",
                        "ProtoObjectTest",
                        "RectangleTest",
                        "RemovePrefixNamePolicyTest",
                        "ScheduleTest",
                        "SetTest",
                        "SMDependencyTest",
                        "SortFunctionTest",
    ...
    public void testYFailingSqueakTests() {
        String[] testClasses = {"ArbitraryObjectSocketTestCase",
                        "ArrayTest",
                        "Ascii85ConverterTest",
                        "Base64MimeConverterTest",
                        "BecomeTest",
                        "BehaviorTest",
                        "BitBltClipBugs",
                        "BlockLocalTemporariesRemovalTest",
                        "BMPReadWriterTest",
                        "BrowserHierarchicalListTest",
                        "BrowserTest",
                        "CharacterScannerTest",
                        "CharacterSetComplementTest",
                        "CharacterSetTest",
                        "CharacterTest",
                        ...
                        "CompilerSyntaxErrorNotifyingTest",
                        "DataStreamTest",
                        "DateAndTimeEpochTest",
                        "DateAndTimeLeapTest",
                        "DateTest",
                        "DebuggerExtensionsTest",
                        "DependentsArrayTest",
                        "DictionaryTest",
                        "DoubleByteArrayTest",
                        "DoubleWordArrayTest",
                        "DurationTest",
                        "EPSCanvasTest",
                        "EtoysStringExtensionTest",
                        "FalseTest",
                        "FileContentsBrowserTest",
                        "FileDirectoryTest",
                        ...
                        "FormCanvasTest",
                        "FormTest",
                        "GradientFillStyleTest",
                        "HierarchicalUrlTest",
                        "HierarchyBrowserTest",
                        "HtmlReadWriterTest",
                        "InstallerUrlTest",
                        ...
                        "MIMEDocumentTest",
                        "MorphicEventDispatcherTests",
                        "MorphicEventFilterTests",
                        ...
                        "SumBugs",
                        "SymbolTest",
                        "SystemChangeFileTest",
                        "TestIndenting",
                        "TestParagraphFix",
                        "TestURI",
                        "TextAnchorTest",
                        "TextAttributesScanningTest",
                        "TextDiffBuilderTest",
                        "TextLineEndingsTest",
                        "TimespanTest",
                        "TimeStampTest",
                        "TimeTest",
                        "UnderscoreSelectorsTest",
                        "UrlTest",
                        "UTF16TextConverterTest",
                        "UTF32TextConverterTest",
                        "UTF8TextConverterTest",
                        "UTFTextConverterWithByteOrderTest",
                        "UUIDPrimitivesTest",
