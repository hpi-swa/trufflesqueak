...
loadColorMap(void)
{
  ...
  if (isWords(cmOop)) {
    ...
    cmShiftTable = loadColorMapShiftOrMaskFrom(fetchPointerofObject(0, cmOop));
    cmMaskTable = loadColorMapShiftOrMaskFrom(fetchPointerofObject(1, cmOop));
...
OLDtallyIntoMapwith(sqInt sourceWord, sqInt destinationWord)
{
  ...
  if (destDepth == 16) {
    ...
    mapIndex = rgbMapfromto(((usqInt) destinationWord) >> 16, 5, cmBitsPerColor);
    /* begin tallyMapAt:put: */
...
void* BitBltPlugin_exports[][3] = {
  ...
  {(void*)_m, "primitiveCompareColors\000\002", (void*)primitiveCompareColors},
  {(void*)_m, "primitiveCopyBits\000\002", (void*)primitiveCopyBits},
  {(void*)_m, "primitiveDisplayString\000\002", (void*)primitiveDisplayString},
  {(void*)_m, "primitiveDrawLoop\000\003", (void*)primitiveDrawLoop},
  {(void*)_m, "primitivePixelValueAt\000\001", (void*)primitivePixelValueAt},
  {(void*)_m, "primitiveWarpBits\000\002", (void*)primitiveWarpBits},
...
signed char primitiveCompareColorsAccessorDepth = 2;
signed char primitiveCopyBitsAccessorDepth = 2;
signed char primitiveDisplayStringAccessorDepth = 2;
signed char primitiveDrawLoopAccessorDepth = 3;
signed char primitivePixelValueAtAccessorDepth = 1;
signed char primitiveWarpBitsAccessorDepth = 2;
