...
import de.hpi.swa.graal.squeak.nodes.plugins.BitBltPluginFactory.FillNodeGen;
...
public final class BitBltPlugin extends AbstractPrimitiveFactoryHolder {
    ...
    public abstract static class FillNode extends Node {
        ...
        protected static FillNode create() {
            return FillNodeGen.create();
        }
...
// @Specialization(guards = {"disableWhileMeasuring()", "hasCombinationRule(receiver, 24)",
// "!hasNilSourceForm(receiver)"})
// protected final Object doCopyBitsCombiRule24WithSourceForm(final VirtualFrame frame, final
// PointersObject receiver) {
// final PointersObject destinationForm = (PointersObject) receiver.at0(BIT_BLT.DEST_FORM);
