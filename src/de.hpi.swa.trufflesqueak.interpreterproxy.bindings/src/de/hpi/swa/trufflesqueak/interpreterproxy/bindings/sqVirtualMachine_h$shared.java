...
public class sqVirtualMachine_h$shared {

    sqVirtualMachine_h$shared() {
    ...
    public static final ValueLayout.OfLong C_LONG /* sqInt */ = System.getProperty("os.name").toLowerCase().contains("win")
