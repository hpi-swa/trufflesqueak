...
public final class LargeIntegerObject extends AbstractSqueakObjectWithHeader {
    ...
    public LargeIntegerObject(final SqueakImageContext image, final long objectHeader, final byte[] bytes) {
