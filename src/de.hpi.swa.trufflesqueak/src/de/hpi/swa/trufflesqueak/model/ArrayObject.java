...
public final class ArrayObject extends AbstractSqueakObjectWithClassAndHash {
    ...
    public void fillin(final SqueakImageChunk chunk) {
        ...
        if (valuesLength > 0) {
            ...
            final ArrayObjectWriteNode writeNode = ArrayObjectWriteNodeGen.create();
    ...
    public int size() {
        ...
        return ArrayObjectSizeNode.getUncached().execute(ArrayObjectSizeNode.getUncached(), this);
    }
