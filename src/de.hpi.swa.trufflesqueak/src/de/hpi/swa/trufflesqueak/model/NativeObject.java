...
public final class NativeObject extends AbstractSqueakObjectWithHeader {
    ...
    private NativeObject(final SqueakImageContext image, final long objectHeader, final Object storage) {
    ...
    public static NativeObject newNativeBytes(final SqueakImageChunk chunk) {
        return new NativeObject(chunk.getImage(), chunk.getObjectHeader(), chunk.getBytes());
    }
    ...
    public static NativeObject newNativeInts(final SqueakImageChunk chunk) {
        return new NativeObject(chunk.getImage(), chunk.getObjectHeader(), UnsafeUtils.toInts(chunk.getBytes()));
    }
    ...
    public static NativeObject newNativeLongs(final SqueakImageChunk chunk) {
        return new NativeObject(chunk.getImage(), chunk.getObjectHeader(), UnsafeUtils.toLongs(chunk.getBytes()));
    }
    ...
    public static NativeObject newNativeShorts(final SqueakImageChunk chunk) {
        return new NativeObject(chunk.getImage(), chunk.getObjectHeader(), UnsafeUtils.toShorts(chunk.getBytes()));
    }
