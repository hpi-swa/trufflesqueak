...
public abstract class SqueakObjectAtPut0Node extends AbstractNode {
    ...
    @Specialization
    protected static final void doLargeInteger(final Node node, final LargeIntegerObject receiver, final long index, final long value) {
        receiver.setNativeAt0(getContext(node), index, value);
    }
