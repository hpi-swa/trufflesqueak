...
public final class DispatchSelector2Node extends DispatchSelectorNode {
    ...
    public abstract static class DispatchDirect2Node extends AbstractDispatchDirectNode {
        ...
        @NeverDefault
        public static DispatchDirect2Node create(final NativeObject selector, final ClassObject lookupClass) {
        ...
        private static DispatchDirect2Node create(final NativeObject selector, final ClassObject lookupClass, final Assumption guardAssumptionOrNull) {
