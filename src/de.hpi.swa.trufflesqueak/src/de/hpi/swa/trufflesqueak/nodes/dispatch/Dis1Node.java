...
import de.hpi.swa.trufflesqueak.nodes.dispatch.Dis1NodeFactory.GenericGuardNodeGen;
...
public final class Dis1Node extends AbstractDispatchNode {
    ...
    static class DirectDisData1Node extends AbstractNode {
        ...
        DirectDisData1Node(final Object receiver, final LookupResult result) {
            ...
            this.dispatchDirectNode = Dispatch1Node.create(result);
    ...
    abstract static class GenericGuardNode extends AbstractGuardNode {
        ...
        boolean doGeneric(final Object receiver,
            ...
            final CompiledCodeObject targetMethod = methodNode.execute(node, image, 1, false, selector, receiverClass, lookupResult);
