...
public abstract class DispatchLookupResultNode extends AbstractDispatchNode {
    ...
    public abstract Object execute(VirtualFrame frame, Object receiver, int receiverClass, Object lookupResult);
    ...
    protected static final Object doCached(final VirtualFrame frame, final Object receiver, final int receiverClassIndex, final Object lookupResult,
                    @Cached("lookupResult") final Object cachedLookupResult,
                    @Cached("create(frame, selector, argumentCount, receiverClassIndex, lookupResult)") final CachedDispatchNode dispatchNode) {
        return dispatchNode.execute(frame);
    }

    @Specialization(replaces = "doCached")
    protected final Object doIndirect(final VirtualFrame frame, final Object receiver, final int receiverClassIndex, final Object lookupResult,
                    @Cached final ResolveMethodNode methodNode,
                    @Cached("create(frame, selector, argumentCount)") final CreateFrameArgumentsForIndirectCallNode argumentsNode,
                    @Cached final IndirectCallNode callNode) {
        final CompiledCodeObject method = methodNode.execute(getContext(), receiverClassIndex, lookupResult);
        return callNode.call(method.getCallTarget(), argumentsNode.execute(frame, receiver, receiverClassIndex, lookupResult, method));
    }
}
