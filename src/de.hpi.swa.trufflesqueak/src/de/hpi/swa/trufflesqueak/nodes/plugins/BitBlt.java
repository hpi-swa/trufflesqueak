...
public final class BitBlt {
    ...
    private boolean loadBitBltDestForm() {
        ...
        destBits = ((NativeObject) destBitsValue).getStorage();
        return destBits.length >= destPitch * destHeight;
    }
    ...
    private boolean loadBitBltSourceForm() {
        ...
        sourceBits = ((NativeObject) sourceBitsValue).getStorage();
        return sourceBits.length >= sourcePitch * sourceHeight;
    }
