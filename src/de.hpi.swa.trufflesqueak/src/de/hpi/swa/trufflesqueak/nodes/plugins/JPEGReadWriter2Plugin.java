...
public final class JPEGReadWriter2Plugin extends AbstractPrimitiveFactoryHolder {
    ...
    protected abstract static class PrimImageHeightNode extends AbstractPrimitiveNode implements BinaryPrimitive {
    ...
    protected abstract static class PrimImageNumComponentsNode extends AbstractPrimitiveNode implements BinaryPrimitive {
    ...
    protected abstract static class PrimImageWidthNode extends AbstractPrimitiveNode implements BinaryPrimitive {
        @Specialization(guards = "aJPEGDecompressStruct.isByteType()")
    ...
    protected abstract static class PrimJPEGCompressStructSizeNode extends AbstractPrimitiveNode implements UnaryPrimitiveWithoutFallback {
        @Specialization
    ...
    protected abstract static class PrimJPEGDecompressStructSizeNode extends AbstractPrimitiveNode implements UnaryPrimitiveWithoutFallback {
        @Specialization
    ...
    protected abstract static class PrimJPEGErrorMgr2StructSizeNode extends AbstractPrimitiveNode implements UnaryPrimitiveWithoutFallback {
        @Specialization
        protected static final long doSize(@SuppressWarnings("unused") final Object receiver) {
            return 0L;
        }
    ...
    protected abstract static class PrimJPEGPluginIsPresentNode extends AbstractPrimitiveNode implements UnaryPrimitiveWithoutFallback {
        @Specialization
    ...
    protected abstract static class PrimSupports8BitGrayscaleJPEGsNode extends AbstractPrimitiveNode implements UnaryPrimitiveWithoutFallback {
        @Specialization
