...
public final class SendBytecodes {
    ...
    public static final class DirectedSuperSendNode extends AbstractSendNode {
        public DirectedSuperSendNode(final VirtualFrame frame, final CompiledCodeObject code, final int successorIndex, final int sp, final int selectorLiteralIndex, final int numArgs) {
            super(frame, successorIndex, sp, numArgs, 1 /* directed class */);
    ...
    public abstract static class SendSpecialNode extends AbstractInstrumentableBytecodeNode {
        private SendSpecialNode(final int successorIndex, final int sp) {
            super(successorIndex, sp);
        }

        public static AbstractBytecodeNode create(final VirtualFrame frame, final int successorIndex, final int sp, final int selectorIndex) {
            return switch (selectorIndex) {
                case 0 /* #+ */ -> new SendSpecial1Node(frame, successorIndex, sp, selectorIndex, BytecodePrimAddNodeGen.create());
                case 1 /* #- */ -> new SendSpecial1Node(frame, successorIndex, sp, selectorIndex, BytecodePrimSubtractNodeGen.create());
                case 2 /* #< */ -> new SendSpecial1Node(frame, successorIndex, sp, selectorIndex, BytecodePrimLessThanNodeGen.create());
                case 3 /* #> */ -> new SendSpecial1Node(frame, successorIndex, sp, selectorIndex, BytecodePrimGreaterThanNodeGen.create());
                case 4 /* #<= */ -> new SendSpecial1Node(frame, successorIndex, sp, selectorIndex, BytecodePrimLessOrEqualNodeGen.create());
                case 5 /* #>= */ -> new SendSpecial1Node(frame, successorIndex, sp, selectorIndex, BytecodePrimGreaterOrEqualNodeGen.create());
                case 6 /* #= */ -> new SendSpecial1Node(frame, successorIndex, sp, selectorIndex, BytecodePrimEqualNodeGen.create());
                case 7 /* #~= */ -> new SendSpecial1Node(frame, successorIndex, sp, selectorIndex, BytecodePrimNotEqualNodeGen.create());
                case 8 /* #* */ -> new SendSpecial1Node(frame, successorIndex, sp, selectorIndex, BytecodePrimMultiplyNodeGen.create());
                case 9 /* #/ */ -> new SendSpecial1Node(frame, successorIndex, sp, selectorIndex, BytecodePrimDivideNodeGen.create());
                case 10 /* #\\ */ -> new SendSpecial1Node(frame, successorIndex, sp, selectorIndex, BytecodePrimModNodeGen.create());
                case 11 /* #@ */ -> new SendSpecial1Node(frame, successorIndex, sp, selectorIndex, BytecodePrimMakePointNodeGen.create());
                case 12 /* #bitShift: */ -> new SendSpecial1Node(frame, successorIndex, sp, selectorIndex, BytecodePrimBitShiftNodeGen.create());
                case 13 /* #// */ -> new SendSpecial1Node(frame, successorIndex, sp, selectorIndex, BytecodePrimDivNodeGen.create());
                case 14 /* #bitAnd: */ -> new SendSpecial1Node(frame, successorIndex, sp, selectorIndex, BytecodePrimBitAndNodeGen.create());
                case 15 /* #bitOr: */ -> new SendSpecial1Node(frame, successorIndex, sp, selectorIndex, BytecodePrimBitOrNodeGen.create());
                // case 16 /* #at: */ -> fallthrough;
                // case 17 /* #at:put: */ -> fallthrough;
                case 18 /* #size */ -> new SendSpecial0Node(frame, successorIndex, sp, selectorIndex, BytecodePrimSizeNodeGen.create());
                // case 19 /* #next */ -> fallthrough;
                // case 20 /* #nextPut: */ -> fallthrough;
                // case 21 /* #atEnd */ -> fallthrough;
                case 22 /* #== */ -> new SendSpecial1Node(frame, successorIndex, sp, selectorIndex, BytecodePrimIdenticalSistaV1NodeGen.create());
                case 23 /* #class */ -> new SendSpecial0Node(frame, successorIndex, sp, selectorIndex, BytecodePrimClassNodeGen.create());
                case 24 /* #~~ */ -> new SendSpecial1Node(frame, successorIndex, sp, selectorIndex, BytecodePrimNotIdenticalSistaV1NodeGen.create());
                ...
                case 30 /* #x: */ -> new SendSpecial0Node(frame, successorIndex, sp, selectorIndex, BytecodePrimPointXNodeGen.create());
                case 31 /* #y: */ -> new SendSpecial0Node(frame, successorIndex, sp, selectorIndex, BytecodePrimPointYNodeGen.create());
                default -> {
                    ...
                    yield new SelfSendNode(frame, successorIndex, sp, specialSelector, numArguments);
                }
            };
        }
        ...
        protected final void rewriteToSend(final VirtualFrame frame, final DispatchBytecodePrimNode dispatchNode) {
            ...
            final NativeObject specialSelector = image.getSpecialSelector(selectorIndex);
            final int numArguments = image.getSpecialSelectorNumArgs(selectorIndex);
            replace(new SelfSendNode(frame, getSuccessorIndex(), getSuccessorStackPointer() + numArguments, specialSelector, numArguments)).executeVoid(frame);
        }
