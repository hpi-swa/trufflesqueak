    ...
    public abstract static class AbstractSendNode extends AbstractInstrumentableBytecodeNode {
        ...
        public final void executeVoid(final VirtualFrame frame) {
            try {
                ...
                if (nlrProfile.profile(nlr.getTargetContext() == getContext(frame))) {
                    if (!getContext(frame).hasTruffleFrame()) {
                        getContext(frame).setFrameAndCode(frame.materialize(), FrameAccess.getCodeObject(frame));
                    }
