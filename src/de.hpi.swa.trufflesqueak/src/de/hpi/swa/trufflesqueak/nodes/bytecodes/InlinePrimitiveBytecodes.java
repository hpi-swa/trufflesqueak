...
public final class InlinePrimitiveBytecodes {
    ...
    protected abstract static class PrimClassNode extends AbstractNullaryInlinePrimitiveNode {
        ...
        protected final void doClass(final VirtualFrame frame,
            ...
            pushNode.execute(frame, classNode.executeLookup(this, popNode.execute(frame)));
        }
    }
    ...
    protected abstract static class PrimFillFromToWithNode extends AbstractQuaternaryInlinePrimitiveNode {
        ...
        public static PrimFillFromToWithNode create(final CompiledCodeObject code, final int index) {
            return PrimFillFromToWithNodeGen.create(code, index);
        }

        @Specialization
        protected final void fillFromToWith(final VirtualFrame frame,
            ...
            for (long i = from; i < to; i++) {
                atPutNode.execute(this, receiver, i, value);
            }
