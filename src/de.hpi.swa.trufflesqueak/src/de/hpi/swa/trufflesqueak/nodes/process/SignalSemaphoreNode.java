...
public abstract class SignalSemaphoreNode extends AbstractNode {
    ...
    @Specialization(guards = {"isSemaphore(semaphore)", "semaphore.isEmptyList(node, readNode)"}, limit = "1")
    ...
    protected static final void doSignal(final VirtualFrame frame, final Node node, final PointersObject semaphore,
        ...
        resumeProcessNode.executeResume(frame, node, semaphore.removeFirstLinkOfList(node, readNode, writeNode));
    }
