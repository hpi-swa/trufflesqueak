...
public final class StoragePrimitives extends AbstractPrimitiveFactoryHolder {
    ...
    protected abstract static class PrimNewWithArgNode extends AbstractPrimitiveNode {
        ...
        protected static final AbstractSqueakObjectWithClassAndHash newWithArgDirect(@SuppressWarnings("unused") final ClassObject receiver, final long size,
                        @Bind("this") final Node node,
                        @Cached final InlinedIntValueProfile sizeProfile,
                        @Cached("receiver.withEnsuredBehaviorHash()") final ClassObject cachedReceiver,
                        @Exclusive @Cached final SqueakObjectNewNode newNode) {
            try {
    ...
    protected abstract static class PrimIdentityHashNode extends AbstractPrimitiveNode implements UnaryPrimitiveFallback {
        ...
        @Specialization
        protected final long doAbstractSqueakObjectWithClassAndHash(final AbstractSqueakObjectWithClassAndHash object,
                        @Cached final InlinedBranchProfile needsHashProfile) {
            return object.getOrCreateSqueakHash(needsHashProfile, this);
        }
    }
    ...
    protected abstract static class PrimArrayBecomeNode extends AbstractPrimitiveNode implements BinaryPrimitiveFallback {
        @Specialization(guards = {"receiverSize == sizeNode.execute(node, other)"}, limit = "1")
        protected static final ArrayObject doBecome(final ArrayObject receiver, final ArrayObject other,
            ...
            getContext(node).flushMethodCacheAfterBecome();
            return receiver;
        }

        @Specialization(guards = {"sizeNode.execute(node, receiver) != sizeNode.execute(node, other)"}, limit = "1")
        @SuppressWarnings("unused")
    ...
    protected abstract static class PrimCharacterValue1Node extends AbstractPrimitiveNode implements UnaryPrimitiveFallback {
        ...
        protected final Object doLong(final long receiver,
                        @Cached final InlinedConditionProfile isImmediateProfile) {
            return CharacterObject.valueOf(receiver, isImmediateProfile, this);
        }
    }
    ...
    protected abstract static class PrimCharacterValue2Node extends AbstractPrimitiveNode implements BinaryPrimitiveFallback {
        ...
        protected final Object doClassLong(@SuppressWarnings("unused") final Object receiver, final long target,
                        @Cached final InlinedConditionProfile isImmediateProfile) {
            return CharacterObject.valueOf(target, isImmediateProfile, this);
        }
    }
    ...
    protected abstract static class PrimArrayBecomeOneWayCopyHashArgNode extends AbstractArrayBecomeOneWayPrimitiveNode implements TernaryPrimitiveFallback {
        ...
        protected final ArrayObject doForward(final ArrayObject fromArray, final ArrayObject toArray, final boolean copyHash,
            ...
            return performPointersBecomeOneWay(fromArray, toArray, copyHashProfile.profile(this, copyHash));
        }
