...
public class Matrix2x3Plugin extends AbstractPrimitiveFactoryHolder {
    ...
    protected abstract static class AbstractMatrix2x3PrimitiveNode extends AbstractPrimitiveNode {
        ...
        protected final double loadArgumentPointX(final Node node, final PointersObject point, final AbstractPointersObjectReadNode readNode, final InlinedBranchProfile errorProfile) {
            return loadArgumentPointAt(node, point, POINT.X, readNode, errorProfile);
        }

        protected final double loadArgumentPointY(final Node node, final PointersObject point, final AbstractPointersObjectReadNode readNode, final InlinedBranchProfile errorProfile) {
            return loadArgumentPointAt(node, point, POINT.Y, readNode, errorProfile);
        }

        private double loadArgumentPointAt(final Node node, final PointersObject point, final int index, final AbstractPointersObjectReadNode readNode, final InlinedBranchProfile errorProfile) {
            if (isPoint(point)) {
        ...
        protected final double[] matrix2x3InvertPoint(final float[] m, final double m23ArgX, final double m23ArgY, final InlinedBranchProfile errorProfile) {
        ...
        protected final PointersObject roundAndStoreResultPoint(final Node node, final double m23ResultXValue, final double m23ResultYValue,
                        final AbstractPointersObjectWriteNode writeNode,
                        final InlinedBranchProfile errorProfile) {
            ...
            return getContext().asPoint(node, writeNode, (long) m23ResultX, (long) m23ResultY);
        }

        protected final PointersObject roundAndStoreResultRect(final Node node, final PointersObject dstRect, final double x0, final double y0, final double x1, final double y1,
                        final AbstractPointersObjectWriteNode writeNode, final InlinedBranchProfile errorProfile) {
            ...
            final PointersObject origin = image.asPoint(node, writeNode, (long) minX, (long) minY);
            final PointersObject corner = image.asPoint(node, writeNode, (long) maxX, (long) maxY);
    ...
    protected abstract static class PrimInvertPointNode extends AbstractMatrix2x3PrimitiveNode implements BinaryPrimitiveFallback {
        ...
        protected final PointersObject doInvert(final NativeObject receiver, final PointersObject point,
            ...
            final double m23ArgX = loadArgumentPointX(node, point, readNode, errorProfile);
            final double m23ArgY = loadArgumentPointY(node, point, readNode, errorProfile);
            final float[] m = loadMatrixAsFloat(receiver);
            final double[] m23Result = matrix2x3InvertPoint(m, m23ArgX, m23ArgY, errorProfile);
            return roundAndStoreResultPoint(node, m23Result[0], m23Result[1], writeNode, errorProfile);
        }
    }
    ...
    protected abstract static class PrimInvertRectIntoNode extends AbstractMatrix2x3PrimitiveNode implements TernaryPrimitiveFallback {
        ...
        protected final PointersObject doInvert(final NativeObject receiver, final PointersObject srcRect, final PointersObject dstRect,
            ...
            final double originX = loadArgumentPointX(node, originPoint, readNode, errorProfile);
            final double originY = loadArgumentPointY(node, originPoint, readNode, errorProfile);
            ...
            final double cornerX = loadArgumentPointX(node, cornerPoint, readNode, errorProfile);
            final double cornerY = loadArgumentPointY(node, cornerPoint, readNode, errorProfile);
            ...
            return roundAndStoreResultRect(node, dstRect, minX, minY, maxX, maxY, writeNode, errorProfile);
        }
    }
    ...
    protected abstract static class PrimTransformPointNode extends AbstractMatrix2x3PrimitiveNode implements BinaryPrimitiveFallback {
        ...
        protected final PointersObject doTransform(final NativeObject receiver, final PointersObject point,
            ...
            final double m23ArgY = loadArgumentPointY(node, point, readNode, errorProfile);
            final float[] m = loadMatrixAsFloat(receiver);
            return roundAndStoreResultPoint(node, matrix2x3TransformPointX(m, m23ArgX, m23ArgY), matrix2x3TransformPointY(m, m23ArgX, m23ArgY), writeNode, errorProfile);
        }
    }
    ...
    protected abstract static class PrimTransformRectIntoNode extends AbstractMatrix2x3PrimitiveNode implements TernaryPrimitiveFallback {
        ...
        protected final PointersObject doTransform(final NativeObject receiver, final PointersObject srcRect, final PointersObject dstRect,
            ...
            final double originX = loadArgumentPointX(node, point0, readNode, errorProfile);
            final double originY = loadArgumentPointY(node, point0, readNode, errorProfile);
            ...
            final double cornerX = loadArgumentPointX(node, point1, readNode, errorProfile);
            final double cornerY = loadArgumentPointY(node, point1, readNode, errorProfile);
