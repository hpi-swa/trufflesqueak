...
public final class DispatchSelector3Node extends DispatchSelectorNode {
    ...
    public abstract static class Dispatch3Node extends AbstractDispatch3Node {
        ...
        public static Dispatch3Node create(final NativeObject selector) {
            return Dispatch3NodeGen.create(selector);
        }
    ...
    public abstract static class DispatchDirect3Node extends AbstractDispatchDirectNode {
        ...
        @NeverDefault
        public static DispatchDirect3Node create(final NativeObject selector, final ClassObject lookupClass) {
        ...
        private static DispatchDirect3Node create(final NativeObject selector, final ClassObject lookupClass, final Assumption guardAssumptionOrNull) {
    ...
    abstract static class DispatchDirectWithSender3Node extends DispatchDirect3Node {
        ...
        DispatchDirectWithSender3Node(final Assumption[] assumptions, final CompiledCodeObject method) {
            super(assumptions);
    ...
    public abstract static class DispatchIndirect3Node extends AbstractNode {
        public abstract Object execute(VirtualFrame frame, Node node, IndirectCallNode callNode, NativeObject selector, Object receiver, Object arg1, Object arg2, Object arg3);
        ...
        protected static final Object doIndirect(final VirtualFrame frame, final Node node, final IndirectCallNode callNode, final NativeObject selector, final Object receiver, final Object arg1,
            ...
            final Object result = tryPrimitiveNode.execute(frame, node, method, receiver, arg1, arg2, arg3);
            if (result != null) {
                return result;
            } else {
                return callNode.call(method.getCallTarget(), argumentsNode.execute(frame, node, receiver, arg1, arg2, arg3, receiverClass, lookupResult, method, selector));
            }
        }
        ...
        protected abstract static class TryPrimitive3Node extends AbstractNode {
            abstract Object execute(VirtualFrame frame, Node node, CompiledCodeObject method, Object receiver, Object arg1, Object arg2, Object arg3);
        ...
        protected abstract static class CreateFrameArgumentsForIndirectCall3Node extends AbstractNode {
            abstract Object[] execute(VirtualFrame frame, Node node, Object receiver, Object arg1, Object arg2, Object arg3, ClassObject receiverClass, Object lookupResult,
            ...
            protected static final Object[] doMethod(final VirtualFrame frame, final Node node, final Object receiver, final Object arg1, final Object arg2, final Object arg3,
                ...
                return FrameAccess.newWith(senderNode.execute(frame, node, method), null, receiver, arg1, arg2, arg3);
            }
            ...
            protected static final Object[] doDoesNotUnderstand(final VirtualFrame frame, final Node node, final Object receiver, final Object arg1, final Object arg2, final Object arg3,
                            final ClassObject receiverClass, @SuppressWarnings("unused") final Object lookupResult, final CompiledCodeObject method, final NativeObject selector,
