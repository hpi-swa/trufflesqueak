...
public final class DispatchSelector4Node extends AbstractDispatchSelectorNode {
    public static final class Dispatch4Node extends AbstractDispatchNode {
        ...
        private Dispatch4Node(final NativeObject selector) {
            super(selector);
        }

        @NeverDefault
        public static Dispatch4Node create(final NativeObject selector) {
            return new Dispatch4Node(selector);
        }
        ...
        private Object executeAndSpecialize(final VirtualFrame frame, final Object receiver, final Object arg1, final Object arg2, final Object arg3, final Object arg4) {
            ...
            final DispatchDirect4Node newDirectNode = DispatchDirect4Node.create(selector, receiverClass, true);
    ...
    public abstract static class DispatchIndirect4Node extends AbstractNode {
        ...
        protected static final Object doIndirect(final VirtualFrame frame, final boolean canPrimFail, final NativeObject selector, final Object receiver, final Object arg1, final Object arg2,
            ...
            if (result != null) {
                ...
                return callNode.call(method.getCallTarget(), argumentsNode.execute(node, senderNode.execute(frame, node), receiver, arg1, arg2, arg3, arg4, receiverClass, lookupResult, selector));
            }
        }
        ...
        protected abstract static class CreateFrameArgumentsForIndirectCall4Node extends AbstractCreateFrameArgumentsForIndirectCallNode {
            ...
            protected static final Object[] doMethod(final Node node, final AbstractSqueakObject sender, final Object receiver, final Object arg1, final Object arg2, final Object arg3,
                            final Object arg4, final ClassObject receiverClass, final CompiledCodeObject lookupResult, final NativeObject selector) {
                return FrameAccess.newWith(sender, null, receiver, arg1, arg2, arg3, arg4);
            }
            ...
            protected static final Object[] doObjectAsMethod(final Node node, final AbstractSqueakObject sender, final Object receiver, final Object arg1, final Object arg2, final Object arg3,
                            final Object arg4, @SuppressWarnings("unused") final ClassObject receiverClass, final Object targetObject, final NativeObject selector) {
                final Object[] arguments = new Object[]{arg1, arg2, arg3, arg4};
