...
public final class DispatchSelector4Node extends DispatchSelectorNode {
    ...
    public abstract static class DispatchIndirect4Node extends AbstractNode {
        ...
        protected static final Object doIndirect(final VirtualFrame frame, final Node node, final IndirectCallNode callNode, final NativeObject selector, final Object receiver, final Object arg1,
            ...
            final Object result = tryPrimitiveNode.execute(frame, node, method, receiver, arg1, arg2, arg3, arg4);
            if (result != null) {
                return result;
            } else {
        ...
        protected abstract static class TryPrimitive4Node extends AbstractNode {
            abstract Object execute(VirtualFrame frame, Node node, CompiledCodeObject method, Object receiver, Object arg1, Object arg2, Object arg3, Object arg4);
