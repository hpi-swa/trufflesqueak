...
public class SqueakMiscellaneousTest extends AbstractSqueakTestCaseWithDummyImage {
    ...
    public void testIfNil() {
        ...
        final AbstractBytecodeNode[] bytecodeNodes = DecoderForV3PlusClosures.SINGLETON.decode(code);
    ...
    public void testSource() {
        ...
        final CharSequence source = DecoderForV3PlusClosures.SINGLETON.decodeToString(code);
