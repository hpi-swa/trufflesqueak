...
public class SqueakMiscellaneousTest extends AbstractSqueakTestCaseWithDummyImage {
    ...
    public void testLoopDecoding() {
        ...
        final int[][] result2 = SqueakBytecodeDecoder.findLoops(code2);
        ...
        // Fake Integer>>#benchmark
        final CompiledCodeObject code = makeMethod(
                        new Object[]{17301507L, image.newSymbol("whileTrue:"), image.newSymbol("#timesRepeat:"), image.schedulerAssociation},
                        0x20, 0x68, 0x76, 0x6E, 0x16, 0x70, 0xB4, 0xAC, 0x3C, 0x75, 0x6C, 0x42, 0x10, 0xCD, 0x71, 0xE1, 0x69, 0x76, 0x6D, 0x15, 0x10, 0xB4, 0xAC, 0x27, 0x11, 0x15, 0xC0, 0xAC, 0x1C,
                        0x15, 0x76, 0xB0, 0x6A, 0x15, 0x12, 0xB0, 0x6B, 0x13, 0x10, 0xB4, 0xAC, 0x0B, 0x11, 0x13, 0x72, 0xC1, 0x87, 0x13, 0x12, 0xB0, 0x6B, 0xA3, 0xF0, 0x14, 0x76, 0xB0, 0x6C, 0x15,
                        0x76, 0xB0, 0x6D, 0xA3, 0xD4, 0x16, 0x76, 0xB0, 0x6E, 0xA3, 0xBF, 0x14, 0x7C);
        final AbstractBytecodeNode[] nodes = SqueakBytecodeDecoder.decode(code);
    }
