 ...
 * }
 */
public final class SDL_AudioPostmixCallback {

    private SDL_AudioPostmixCallback() {
    ...
    private static final MethodHandle UP$MH = SDL_h.upcallHandle(SDL_AudioPostmixCallback.Function.class, "apply", $DESC);
