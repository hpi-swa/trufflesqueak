...
public class __darwin_pthread_handler_rec {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        SDL_h.C_POINTER.withName("__routine"),
        SDL_h.C_POINTER.withName("__arg"),
        SDL_h.C_POINTER.withName("__next")
    ...
    public final static class __routine {
        ...
        private static final MethodHandle UP$MH = SDL_h.upcallHandle(__routine.Function.class, "apply", $DESC);
