...
public class __sFILE {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        SDL_h.C_POINTER.withName("_p"),
        SDL_h.C_INT.withName("_r"),
        SDL_h.C_INT.withName("_w"),
        SDL_h.C_SHORT.withName("_flags"),
        SDL_h.C_SHORT.withName("_file"),
        MemoryLayout.paddingLayout(4),
        __sbuf.layout().withName("_bf"),
        SDL_h.C_INT.withName("_lbfsize"),
        MemoryLayout.paddingLayout(4),
        SDL_h.C_POINTER.withName("_cookie"),
        SDL_h.C_POINTER.withName("_close"),
        SDL_h.C_POINTER.withName("_read"),
        SDL_h.C_POINTER.withName("_seek"),
        SDL_h.C_POINTER.withName("_write"),
        __sbuf.layout().withName("_ub"),
        SDL_h.C_POINTER.withName("_extra"),
        SDL_h.C_INT.withName("_ur"),
        MemoryLayout.sequenceLayout(3, SDL_h.C_CHAR).withName("_ubuf"),
        MemoryLayout.sequenceLayout(1, SDL_h.C_CHAR).withName("_nbuf"),
        __sbuf.layout().withName("_lb"),
        SDL_h.C_INT.withName("_blksize"),
        MemoryLayout.paddingLayout(4),
        SDL_h.C_LONG_LONG.withName("_offset")
    ).withName("__sFILE");
    ...
    public final static class _close {
        ...
        private static final MethodHandle UP$MH = SDL_h.upcallHandle(_close.Function.class, "apply", $DESC);
    ...
    public final static class _read {
        ...
        private static final MethodHandle UP$MH = SDL_h.upcallHandle(_read.Function.class, "apply", $DESC);
    ...
    public final static class _seek {
        ...
        private static final MethodHandle UP$MH = SDL_h.upcallHandle(_seek.Function.class, "apply", $DESC);
    ...
    public final static class _write {
        ...
        private static final MethodHandle UP$MH = SDL_h.upcallHandle(_write.Function.class, "apply", $DESC);
    ...
    public static byte _ubuf(MemorySegment struct, long index0) {
        return (byte)_ubuf$ELEM_HANDLE.get(struct, _ubuf$OFFSET, index0);
    }
    ...
    public static void _ubuf(MemorySegment struct, long index0, byte fieldValue) {
        _ubuf$ELEM_HANDLE.set(struct, _ubuf$OFFSET, index0, fieldValue);
    }
    ...
    public static byte _nbuf(MemorySegment struct, long index0) {
        return (byte)_nbuf$ELEM_HANDLE.get(struct, _nbuf$OFFSET, index0);
    }
    ...
    public static void _nbuf(MemorySegment struct, long index0, byte fieldValue) {
        _nbuf$ELEM_HANDLE.set(struct, _nbuf$OFFSET, index0, fieldValue);
    }
