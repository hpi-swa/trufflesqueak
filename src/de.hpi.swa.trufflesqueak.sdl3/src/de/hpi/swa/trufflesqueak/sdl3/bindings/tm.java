...
public class tm {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
                    SDL_h.C_INT.withName("tm_sec"),
                    SDL_h.C_INT.withName("tm_min"),
                    SDL_h.C_INT.withName("tm_hour"),
                    SDL_h.C_INT.withName("tm_mday"),
                    SDL_h.C_INT.withName("tm_mon"),
                    SDL_h.C_INT.withName("tm_year"),
                    SDL_h.C_INT.withName("tm_wday"),
                    SDL_h.C_INT.withName("tm_yday"),
                    SDL_h.C_INT.withName("tm_isdst"),
                    MemoryLayout.paddingLayout(4),
                    SDL_h.C_LONG.withName("tm_gmtoff"),
                    SDL_h.C_POINTER.withName("tm_zone")).withName("tm");
